...
+++ {"deletable": false, "nbgrader": {"cell_type": "markdown", "checksum": "0a075649f082eb8f92f9ccca0a9ea904", "grade": false, "grade_id": "cell-1e200cdecbc22415", "locked": true, "schema_version": 3, "solution": false, "task": false}, "user_expressions": []}
...
- [x] Assurez-vous que le répertoire `data` ne contienne rien
...
+++ {"deletable": false, "editable": false, "nbgrader": {"cell_type": "markdown", "checksum": "ef4ae4fc53cb9b133fdea98db18d232f", "grade": false, "grade_id": "cell-c3380759576c39ca", "locked": true, "schema_version": 3, "solution": false, "task": false}, "user_expressions": []}
...
```{code-cell} ipython3
img = Image.open(os.path.join(dataset_dir, 'a11.jpg'))
extract_metadata(img)
```

```{code-cell} ipython3
img = Image.open(os.path.join(dataset_dir, 'a10.jpg'))
extract_metadata(img)
```

Très peu de mes images ont des métadonnées, rendant impossible l'analyse des métadonnées
